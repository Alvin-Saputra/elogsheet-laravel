    ...
    <div class="flex items-center space-x-3">
      ...
      <div>
        <h2 class="text-lg font-semibold text-gray-800">
          Analytical Result of Outgoing Shipment By Vessel
        </h2>
          ...
          <tr class="{{ $index % 2 ? 'bg-gray-50' : 'bg-white' }}">
                        ...
                        <div @click.outside="open = false" class="bg-white w-full max-w-md rounded-lg shadow-lg p-6">
                          ...
                          <form method="POST"
                            ...
                            <div class="flex justify-end gap-2">
                              <button type="button" @click="open = false" class="px-4 py-2 text-sm bg-gray-300 rounded">
                                Cancel
                              </button>
            ...
            <td class="px-4 py-2 border-b">
              <div class="flex items-center gap-2 justify-between">
                <a target="_blank"
                  href="{{ route('analytical-result-outgoing-shipment-by-vessel.preview', $doc->id) }}?intention=preview"
